...
# Modified to 6M frames, MASAC & MAPPO only, and eps_end=0.05
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.checkpoint_interval=150000 experiment.keep_checkpoints_num=40 experiment.exclude_buffer_from_checkpoint=true experiment.project_name="Lux_Thesis_16CH_v2_BiggerCNN_6M" experiment.wandb_extra_kwargs.name="masac_16ch_biggercnn_6M_run"
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.checkpoint_interval=150000 experiment.keep_checkpoints_num=40 experiment.exclude_buffer_from_checkpoint=true experiment.project_name="Lux_Thesis_16CH_v2_BiggerCNN_6M" experiment.wandb_extra_kwargs.name="mappo_16ch_biggercnn_6M_run"
